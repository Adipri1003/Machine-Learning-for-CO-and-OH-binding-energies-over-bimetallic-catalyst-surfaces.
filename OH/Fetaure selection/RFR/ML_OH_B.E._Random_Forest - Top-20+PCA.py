...
df3 = df2.drop(labels=["OH_B.E",'M-Density', 'M-B.P', 'M-Enth.fus', 'M-Enth.vap', 'M-cova .radii', 'M-At.radii', 'M-Period', 'At No.', 'At wt.', 'M.P', 'Enth.fus', 'Enth.atom', 'Enth.vap', 'Surface.E', '1st Ion E', 'Period'], axis=1)
df3
...
PCA_df = pd.read_csv('PCA_add_5.csv')
