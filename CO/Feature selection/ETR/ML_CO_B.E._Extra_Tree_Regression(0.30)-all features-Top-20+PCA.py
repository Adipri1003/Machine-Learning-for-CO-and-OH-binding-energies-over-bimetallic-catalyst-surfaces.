...
df3 = df2.drop(labels=["CO_B.E",'M-At wt.', 'M-Enth.atom', 'M-Enth.vap', 'M-Sp.ht Cap', 'M-Elec.-ve', 'M-Period', 'At No.', 'At wt.', 'Density', 'Enth.atom', 'Enth.vap', 'Sp.ht Cap', '1st Ion E', 'Group', 'Period', 'Elec.Aff'], axis=1)
df3
