...
df3 = df2.drop(labels=["CO_B.E",'M-At No.', 'M-At wt.', 'M-Density', 'M-Enth.atom', 'M-Enth.vap', 'M-Sp.ht Cap', 'M-Elec.-ve', 'M-1st Ion E', 'M-cova .radii', 'M-At.radii', 'M-Period', 'M-Work F.', 'At No.', 'At wt.', 'Density', 'Enth.atom', 'Enth.vap', 'Sp.ht Cap', 'Elec.-ve', 'Surface.E', '1st Ion E', 'cova .radii', 'Group', 'Period', 'Work F.', 'Elec.Aff'], axis=1)
df3
