...
df2=df.iloc[:,6:9]
df2
df2 = df.drop(columns=['Element','CO_B.E','M-M.P','M-Surface.E','M-B.P','M-Group','M-Enth.fus','Enth.fus','M.P','B.P','At.radii','M-Elec.Aff',
                      'cova .radii','Group','Elec.-ve','Surface.E','M-cova .radii','M-1st Ion E','M-At No.', 'M-At wt.', 'M-Density','Work F.',]) # Replace with the actual column names
df2
