...
df3 = df2.drop(labels=["CO_B.E"], axis=1)
df3
...
x = df_pred.drop(labels=["Element","CO_B.E"], axis=1)
x
...
output_file_CO_HT = 'output_data_CO_xGBR(0.30)_all_features_36.xlsx'
...
plt.figure(figsize=(12, 8))
feat_importances.nlargest(36).plot(kind='bar')
plt.xlabel('Features')
plt.ylabel('Importance - scale (0-1)')
plt.show()
